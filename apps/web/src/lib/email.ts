    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
        ...
        <div style="background:#f4f4f5;border-radius:8px;padding:16px;margin-bottom:16px">
          <p style="margin:0 0 8px;font-size:12px;color:#71717a;text-transform:uppercase;letter-spacing:.05em">${escapeHtml(opts.category)}</p>
          <p style="margin:0;color:#1a1a1a">${escapeHtml(opts.entryContent)}</p>
        </div>
